...
const AdminNewVolume = () => {
  ...
  const handleChange = (
    ...
    setFormData({
      ...formData,
      [name]: name === "issueNumber" || name === "year" || name === "month" ? parseInt(value) : value,
    });
  };
  ...
  return (
    <AdminLayout title="Create New Volume">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold mb-6">Create New Volume</h2>
